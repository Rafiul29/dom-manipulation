...
//Outcomes
const outcomes = account.movements.filter(move=> move < 0).
...
///////////////////////////////////////
let sortedMoved=false;


btnSort.addEventListener('click',function(e){
  e.preventDefault();
  displayMovements(currentAccount, !sortedMoved)
  sortedMoved = !sortedMoved
})
